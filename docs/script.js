...
function createWallpaperCard(item, isPriority) {
  ...
  const countBadge = imageCount > 0 ? `<span class="count-badge"><svg class="count-badge-icon" viewBox="0 0 34 34" fill="none" aria-hidden="true"><use href="#icon-wallpaper-count"></use></svg>${imageCount}</span>` : '';
